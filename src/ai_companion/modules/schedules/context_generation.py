...
class ScheduleContextGenerator:
    """Class to generate context about ananya's current activity based on schedules."""
    ...
    def get_current_activity(cls) -> Optional[str]:
        """Get ananya's current activity based on the current time and day of the week.
